        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {categories.map((category: any) => (
            <Link 
              ...
              className="group relative bg-gray-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:border-white/20 transition-all duration-500 hover:scale-105"
            >
              <div className={`absolute inset-0 bg-gradient-to-r ${colorMap[category.color] || 'from-blue-500 to-cyan-500'} opacity-0 group-hover:opacity-10 rounded-2xl transition-opacity duration-500`} />
              
              <div className="relative z-10">
                <div className={`w-16 h-16 bg-gradient-to-r ${colorMap[category.color] || 'from-blue-500 to-cyan-500'} rounded-xl flex items-center justify-center mb-6 text-2xl`}>
                  {category.icon === 'code' && '💻'}
                  {category.icon === 'api' && '🔌'}
